# Learning Graph for AI Strategy for Education
...
This learning graph contains **214 concepts** organized into **13 categories**, connected by
**313 learning-dependency edges**. It is built on **2 foundational concepts** — *Artificial
Intelligence* and *Exponential Growth* — and culminates in the capstone concepts *Capstone AI
Strategy* and *Board Ready Strategy*.
...
- A concept classifier taxonomy with approximately 13 categories (+/- 1 or 2)
