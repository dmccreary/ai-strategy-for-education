...
[Run the The METR Task Horizon Timeline MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/metr-task-horizon-timeline/main.html"
        height="502"
        width="100%"
        scrolling="no"></iframe>
```
