...
# The Idea Funnel — Six Stages

<iframe src="main.html" height="562" width="100%" scrolling="no"></iframe>

[Run the The Idea Funnel — Six Stages MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/idea-funnel-stages/main.html"
        height="562"
        width="100%"
        scrolling="no"></iframe>
```
