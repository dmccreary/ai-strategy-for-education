...
[Run the Anatomy of an Intelligent Textbook MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/intelligent-textbook-stack/main.html"
        height="552"
        width="100%"
        scrolling="no"></iframe>
```
