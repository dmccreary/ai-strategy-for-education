...
[Run the Gap Analysis — Current State to Target State MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/gap-analysis-diagram/main.html"
        height="662"
        width="100%"
        scrolling="no"></iframe>
```
