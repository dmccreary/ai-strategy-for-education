...
[Run the Sources of Algorithmic Bias in Education AI MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/algorithmic-bias-sources/main.html"
        height="522"
        width="100%"
        scrolling="no"></iframe>
```
