...
[Run the Stakeholder Alignment Map MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/stakeholder-alignment-map/main.html"
        height="542"
        width="100%"
        scrolling="no"></iframe>
```
