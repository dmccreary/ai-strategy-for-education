...
# AI Program Pipeline Report

<iframe src="main.html" height="642" width="100%" scrolling="no"></iframe>

[Run the AI Program Pipeline Report MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/pipeline-report-dashboard/main.html"
        height="642"
        width="100%"
        scrolling="no"></iframe>
```
