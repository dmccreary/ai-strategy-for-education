...
[Run the SWOT Analysis Framework MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/swot-analysis-builder/main.html"
        height="607"
        width="100%"
        scrolling="no"></iframe>
```
