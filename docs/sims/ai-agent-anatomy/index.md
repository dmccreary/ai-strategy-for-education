...
[Run the Anatomy of an AI Agent MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/ai-agent-anatomy/main.html"
        height="562"
        width="100%"
        scrolling="no"></iframe>
```
