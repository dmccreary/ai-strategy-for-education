...
[Run the Center of Excellence Organizational Structure MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/coe-org-chart/main.html"
        height="542"
        width="100%"
        scrolling="no"></iframe>
```
