...
[Run the The Institutional Agent Workforce MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ai-strategy-for-education/sims/agent-workforce-diagram/main.html"
        height="592"
        width="100%"
        scrolling="no"></iframe>
```
